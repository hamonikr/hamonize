    ...
    m_lockWidget( nullptr )
{
    ...
    QPushButton *btnLock = new QPushButton(tr("Lock"), this);
    btnLock->setGeometry(QRect(QPoint(100,h+d*3), QSize(100,50)));

    QPushButton *btnUnlock = new QPushButton(tr("Unlock"), this);
    btnUnlock->setGeometry(QRect(QPoint(100,h+d*4), QSize(100,50)));
    ...
    connect( btnLock, SIGNAL (released()), this, SLOT ( lockTest() ) );
    connect( btnUnlock, SIGNAL (released()), this, SLOT ( unlockTest() ) );
