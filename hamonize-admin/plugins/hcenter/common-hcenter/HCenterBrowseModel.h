/*
 * HCenterModel.h - item model for browsing HCenter directories
 *
...
class HCenterBrowseModel : public QAbstractItemModel
{
	Q_OBJECT
public:
    using Node = HCenterBrowseModelNode;
    ...
    HCenterBrowseModel( Mode mode, const HCenterConfiguration& configuration, QObject* parent = nullptr );
    ~HCenterBrowseModel() override;
