...
ServiceControlPlugin::ServiceControlPlugin( QObject* parent ) :
	QObject( parent ),
	m_commands( {
{ QStringLiteral("register"), tr( "Register Hamonize Service" ) },
{ QStringLiteral("unregister"), tr( "Unregister Hamonize Service" ) },
{ QStringLiteral("start"), tr( "Start Hamonize Service" ) },
{ QStringLiteral("stop"), tr( "Stop Hamonize Service" ) },
{ QStringLiteral("restart"), tr( "Restart Hamonize Service" ) },
{ QStringLiteral("status"), tr( "Query status of Hamonize Service" ) },
				} )
{
}
