...
public class CurlBackupController {
	...
	// @RequestMapping("/setStartBackupRecoveryJob")
	// public String  setStartBackupRecoveryJob(@RequestBody String valLoad ) throws Exception {

	// 	String output = "";
	// 	System.out.println("setStartBackupRecoveryJob valLoad==="+ valLoad);
	...
	// @RequestMapping("/setEndBackupRecoveryJob")
	// public String  setEndBackupRecoveryJob(@RequestBody String valLoad ) throws Exception {

	// 	String output = "";
	// 	System.out.println(" setEndBackupRecoveryJob valLoad==="+ valLoad);
