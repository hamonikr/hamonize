...
public class CurlAgentAdminkeyController {
    ...
    public String getprivatekey( FileVo vo, HttpServletRequest request,HttpServletResponse response) throws UnsupportedEncodingException {
        vo = fileMapper.getFilePrivate();
        File file = new File(vo.getFilepath());
		String ret ="";
