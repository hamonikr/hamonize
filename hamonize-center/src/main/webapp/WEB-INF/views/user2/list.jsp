                  ...
                  <ul class="location">
                    ...
                    <div class="top_search w100">
                        <select id="keyWord" name="keyWord" title="keyWord" class="sel_type1">
                            ...
                            <option value="3" <c:if test="${keyWord eq '3' }">selected</c:if>>담당사지방</option>
                        </select>
...
<%-- <p id="contentTitle">사지방관리자등록관리</p>
...
<div class="btn_area">
	<a href="<c:url value='managerview.do'/>" class="btn act">관리자등록</a>
</div>
<!-- 페이징 -->
