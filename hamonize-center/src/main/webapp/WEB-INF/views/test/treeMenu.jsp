...
<aside class="lnb" style="width:100%">
	...
	var tree = new tui.Tree('tree', {
	    ...
	    template: {
	        internalNode:
	            '<div class="tui-tree-content-wrapper" style="padding-left: {{indent}}px">' +
	                '<button type="button" class="tui-tree-toggle-btn tui-js-tree-toggle-btn">' +
	                    ...
	                    '{{stateLabel}}' +
	                '</button>' +
	                '<span class="tui-tree-text tui-js-tree-text groupLabel" data-value="{{step}}" data-upcode="{{uppercode}}" data-code="{{code}}" data-seq="{{seq}}">' +
	        ...
	        leafNode:
	            '<div class="tui-tree-content-wrapper" style="padding-left: {{indent}}px">' +
	                '<span class="tui-tree-text tui-js-tree-text node groupLabel" data-value="{{step}}" data-upcode="{{uppercode}}" data-code="{{code}}" data-seq="{{seq}}">' +
	                    '<label class="tui-checkbox">' +
	                       '<span class="tui-ico-check"><input type="checkbox" class="tui-tree-checkbox"></span>' +
	                    '</label>' +
