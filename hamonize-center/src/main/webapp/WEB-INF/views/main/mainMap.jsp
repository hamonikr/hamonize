           ...
           <div class="card card-h-100">
               <div class="card-body">
                   <div class="alert alert-warning alert-dismissible fade show mb-3" role="alert">
						...
						<iframe id="monitor" title="Main monitoring" src="http://ts.hamonikr.org:3000/d-solo/nprv87G7z/hamonize-main2?orgId=1&refresh=10s&panelId=2" width="100%" height="350" frameborder="0" ></iframe>
                </div> <!-- end card-body-->
           </div> <!-- end card-->
       </div>
