...
<!-- <script src="/js/views/securityManagement.js"></script> -->
			...
			<div class="code-html contents row">
				...
				<div class="form-style-10">
					...
					<form method="post" class="">
				    	...
				    	<div class="section"><span>2</span>방화벽 관리</div>
				    	<div class="inner-wrap row">
							<div id="pageGrideInHmprogramUdpt" class="row"  style="width:100%;"></div>
				    	</div>
				    	
				    	<div class="section"><span>3</span>디바이스관리</div>
				    	<div class="inner-wrap row">
							<div id="securityDevice" class="row"  style="width:100%;"></div>
				    	</div>
						
				    	<div class="section"><span>4</span>보안관리 적용</div>
...
function getSecurityList2(){
	var url ='/gplcs/securityManagement.proc';
	var keyWord = $("select[name=keyWord]").val();
	var vData = "selectOrgName=" + $("#gbcdval").attr("data-orgseq") +"&selectOrgUpperCode=" + $("#gbcdval").attr("data-code");
	callAjax('POST', url, vData, hmSecurityGetSuccess, getError, 'json');
}
